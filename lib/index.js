...
var BASE_URL = "http://34.71.110.209:44800";
var LOCAL_BASE_URL = "http://localhost:44800";
var Vyle = /** @class */ (function () {
    function Vyle(token) {
        ...
        this.file = {
            list: function (_a) {
                var _b = _a === void 0 ? {} : _a, page = _b.page, perPage = _b.perPage, expiresIn = _b.expiresIn, sortBy = _b.sortBy;
                    ...
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            case 0: return [4 /*yield*/, this.fetcher("/project/file", {
                                    method: "post",
                                    data: { page: page, perPage: perPage, expiresIn: expiresIn, sortBy: sortBy },
                                })];
                            case 1:
                                result = _c.sent();
            ...
            remove: function (fileId) { return __awaiter(_this, void 0, void 0, function () {
    ...
    Vyle.addProject = function (email) {
        return __awaiter(this, void 0, void 0, function () {
